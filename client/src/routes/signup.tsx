          ...
          <form onSubmit={handleSubmit}>
            <div>
              ...
              <p className="validator-hint hidden">
                3 to 30 characters only letters
              </p>
            </div>
            <div className="mt-3">
              <label className="input validator">
            ...
            <div className="mt-3">
              <label className="input validator">
                ...
                <input
                  ...
                  minLength={8}
                  title="Must be more than 8 characters long"
            ...
            <div className="card-actions mt-4">
              ...
              >
                {loading ? (
                  <>
                    <span className="loading loading-spinner loading-sm text-base-300"></span>
